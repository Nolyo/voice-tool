 ...
 * `content_html` exceeds 3 MB (Zod `max(3_145_728)` on code units) AND the DB
 * enforces `octet_length(content_html) <= 3_145_728` on bytes. Because the Zod
 ...
 */
export const NOTE_SIZE_LIMIT_BYTES = 3_145_728;
